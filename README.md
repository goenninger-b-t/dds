...
`fastdds-type-information-vector`, matching our hash + serialized size byte-for-byte); the
byte-level TypeLookup CONFIRM-VS-PEER re-pin is the remaining FR-IO-2 step.
