...
(declaim (ftype (function (rtps-writer (unsigned-byte 32)) reader-proxy) get-reader-proxy))
...
(declaim (ftype (function (rtps-writer t) integer) writer-write))
...
(declaim (ftype (function (rtps-writer) (values integer integer integer)) writer-heartbeat))
...
(declaim (ftype (function (rtps-writer (unsigned-byte 32)) list) writer-data-list))
...
(declaim (ftype (function (rtps-writer (unsigned-byte 32) integer (unsigned-byte 32) (simple-array (unsigned-byte 32) (*))) (values list list)) writer-on-acknack))
...
(declaim (ftype (function (rtps-reader (unsigned-byte 32) integer t) t) reader-on-data))
...
(declaim (ftype (function (rtps-reader (unsigned-byte 32) integer integer) t) reader-on-heartbeat))
...
(declaim (ftype (function (rtps-reader (unsigned-byte 32)) (values integer (unsigned-byte 32) (simple-array (unsigned-byte 32) (*)))) reader-acknack))
...
(declaim (ftype (function (rtps-reader (unsigned-byte 32) integer integer (unsigned-byte 32) (simple-array (unsigned-byte 32) (*))) t) reader-on-gap))
...
(declaim (ftype (function (rtps-reader (unsigned-byte 32)) t) reader-complete-p))
