...
(defpackage #:net.goenninger.dds.disc
  ...
  (:export #:disc-node #:disc-node-p #:make-disc-node
           ...
           #:disc-node-stuck-receiver-teardowns #:disc-node-teardown-leaked #:disc-node-unrouted-match-drops #:disc-node-hb-unarmed-drops #:disc-node-durability-gate-active
           ...
           #:node-sample-count #:node-sample #:node-sample-raw #:node-sample-sns #:*rx-store-pool-capacity* #:*rx-store-pool-enabled*
