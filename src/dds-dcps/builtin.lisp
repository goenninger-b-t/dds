...
(declaim (ftype (function ((simple-array (unsigned-byte 8) (12))) (simple-array (unsigned-byte 8) (16))) %prefix->key))
...
(declaim (ftype (function ((simple-array (unsigned-byte 8) (16))) (simple-array (unsigned-byte 8) (16))) %guid->participant-key))
...
(declaim (ftype (function (domain-participant) list) get-builtin-participant-data))
...
(declaim (ftype (function (dds.rtps.discovery:endpoint-data) publication-builtin-topic-data) %endpoint->publication))
...
(declaim (ftype (function (dds.rtps.discovery:endpoint-data) subscription-builtin-topic-data) %endpoint->subscription))
...
(declaim (ftype (function (domain-participant) list) get-builtin-publication-data))
...
(declaim (ftype (function (domain-participant) list) get-builtin-subscription-data))
...
(declaim (ftype (function (domain-participant) list) get-builtin-topic-data))
