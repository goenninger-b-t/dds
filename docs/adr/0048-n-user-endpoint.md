...
- **Status:** Accepted (WP-N-ENDPOINT-S0-REGISTRY, 2026-07-05). Slices S0 + **S1 (N local writers)** + **S2 (N local readers)** + **S3 (per-endpoint crypto key material — N secured writers)** landed; S4–S5 planned (not started).
