...
| [Distributed logging](logging.md) | `dds-log` | the `LogEvent` wire type (ADR 0082) — `@appendable`, source-keyed, bounded, RFC 5424 severities; the emit path/formatters/sinks/service are follow-on slices |
