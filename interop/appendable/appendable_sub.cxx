// appendable_sub — Connext subscribes to the @appendable ShapeType on topic "Square".
// Interop Leg 1 (cross-DDS half), IN direction: run NeoDDS's  make square-pub TYPE=appendable
// and verify a real Connext reader accepts our D_CDR2_LE 0x0009 + DHEADER framing.
//
// Usage: ./appendable_sub [domain=0] [seconds=0]  (0 = run until Ctrl-C)
// Env:   CONNEXT_VERBOSE=1 surfaces discovery/match decisions on stderr.
...
int main(int argc, char **argv)
{
    ...
    std::cout << "[connext-sub] Square/" << topic.type_name() << " (@appendable) domain=" << domain
