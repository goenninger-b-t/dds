...
for f in "${PERM_CA_CERT}" "${PERM_CA_KEY}" "${PKI_DIR}/governance-none.xml" "${PKI_DIR}/governance-secure.xml"; do
...
for f in "${CERTS_DIR}/governance-none.smime" "${CERTS_DIR}/governance-secure.smime" "${CERTS_DIR}/permissions-hello.smime"; do
